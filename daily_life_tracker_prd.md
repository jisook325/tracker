...
- 초기 구현 시에는 **개발 난이도를 고려한 단순한 인증 방식**을 우선 선택하고,
  - Google OAuth 도입 여부는 이후 단계에서 재검토한다.
...
> 본 문서는 Living PRD로서, 이후 Step 8(Next Agent Handoff) 단계에서 지속적으로 업데이트한다.
